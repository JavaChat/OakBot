...
class UnitConversionListenerTest {
	...
	void onMessage_temperature() {
		assertResponse("it's 40f right now", "🌡 40°F = 4.44°C = 277.59K = 499.67°R");
		assertResponse("it's -40f right now", "🌡 -40°F = -40°C = 233.15K = 419.67°R");
		assertResponse("it's 40 f right now", "🌡 40°F = 4.44°C = 277.59K = 499.67°R");
		assertResponse("it's 40°F right now", "🌡 40°F = 4.44°C = 277.59K = 499.67°R");
		assertResponse("it's 40&#176;F right now", "🌡 40°F = 4.44°C = 277.59K = 499.67°R");
		assertResponse("it's 40 degrees f right now", "🌡 40°F = 4.44°C = 277.59K = 499.67°R");
		assertResponse("it's 40 deg f right now", "🌡 40°F = 4.44°C = 277.59K = 499.67°R");
		assertResponse("it's 40 fahrenheit right now", "🌡 40°F = 4.44°C = 277.59K = 499.67°R");

		assertResponse("it's 40c right now", "🌡 40°C = 104°F = 313.15K = 563.67°R");
		assertResponse("it's 40 c right now", "🌡 40°C = 104°F = 313.15K = 563.67°R");
		assertResponse("it's 40°C right now", "🌡 40°C = 104°F = 313.15K = 563.67°R");
		assertResponse("it's 40&#176;C right now", "🌡 40°C = 104°F = 313.15K = 563.67°R");
		assertResponse("it's 40 degrees c right now", "🌡 40°C = 104°F = 313.15K = 563.67°R");
		assertResponse("it's 40 deg c right now", "🌡 40°C = 104°F = 313.15K = 563.67°R");
		assertResponse("it's 40 celsius right now", "🌡 40°C = 104°F = 313.15K = 563.67°R");
		assertResponse("it's 40 centigrade right now", "🌡 40°C = 104°F = 313.15K = 563.67°R");

		assertResponse("the photosphere of the sun is 5800 kelvin", "🌡 5,800K = 5,526.85°C = 9,980.33°F = 10,440°R");
	}

	@Test
	void onMessage_temperature_zero() {
		assertResponse("0f", "🌡 0°F = -17.78°C = 255.37K = 459.67°R");
		assertResponse("0c", "🌡 0°C = 32°F = 273.15K = 491.67°R");
		assertResponse("0 kelvin", "🌡 0K = -273.15°C = -459.67°F = 0°R");
	}
	...
	void onMessage_decimal_separator() {
		assertResponse("it's 40.6f right now", "🌡 40.6°F = 4.78°C = 277.93K = 500.27°R");
		assertResponse("it's 40,6f right now", "🌡 40.6°F = 4.78°C = 277.93K = 500.27°R");
	}

	@Test
	void onMessage_remove_duplicates() {
		assertResponse("it's 40f right now. yesterday it was 34f and the day before it was 40f", "🌡 40°F = 4.44°C = 277.59K = 499.67°R\n🌡 34°F = 1.11°C = 274.26K = 493.67°R");
	}
